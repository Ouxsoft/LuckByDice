<h1>LuckByDice</h1>
    <a href="https://travis-ci.com/github/ouxsoft/LuckByDice"><img src="https://api.travis-ci.com/ouxsoft/LuckByDice.svg?branch=master&status=passed" alt="Build Status"></a>
